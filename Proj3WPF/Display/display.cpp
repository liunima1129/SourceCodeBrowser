...
void toggleDisplay::htmlGenerate(const std::string& filename, std::vector<std::string> _de, countTable _tables, std::string outpath_)
{
	...
	std::ofstream fout;
	fout.open(outpath_ + "\\" + realName(filename) + ".html");
